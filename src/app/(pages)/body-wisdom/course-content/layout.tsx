...
function BodyWisdomCourseLayout({
	children,
		...
		return (
			<>
				<div className="flex flex-col items-center justify-center w-full h-screen">
					<p className="text-4xl">You must be signed in to access this page.</p>
					<p className="text-4xl">
						Please <StyledLink href="/api/auth/signin">sign in</StyledLink> or{" "}
