            ...
            <FullWidthColorBackground variant="white" textColor="secondary">
                <h1 className="font-transat-bold text-balance text-2xl sm:text-3xl md:text-5xl text-center">
                    <span className="text-brightgreen-500 uppercase">
                        Spend less time stressing over meals so you can spend
                        more time on the things you love...
                    </span>
                </h1>
            ...
            <FullWidthColorBackground variant="primary">
                <>
                    ...
                    <p className="font-transat-light-obl mb-8">
                        The recipes in this download are designed to help you
                        get nourishing, balanced meals on the table in less time
                ...
                <div className="w-full text-left max-w-5xl flex flex-col gap-2 mb-12">
                    <div className="w-full mx-auto p-2">
                        ...
                        <div className="mt-3 text-xl leading-6 whitespace-normal text-slate-600 transition-all duration-150 ease-in-out">
                            <p>
                                You don&apos;t need a lot of cooking skills to
                                bring these recipes to the table, and
                                they&apos;re incredibly flexible. Best of all,
                                they come together in only 30 minutes, so you
                                can spend your evenings doing more of the things
                                you enjoy while sticking to your healthy eating
                                goals.
                            </p>
                        </div>
                    </div>
                    <div className="w-full mx-auto p-2">
                        ...
                        >
                            ...
                            <div className="mt-3 text-xl leading-6 whitespace-normal text-slate-600 transition-all duration-150 ease-in-out">
                                <p>
                                    7 one-pan dinner recipes designed to nourish
                                    your gut and your body with variety and
                                    balanced nutrients.
                                </p>
                            </div>
                        </details>
