        ...
        <main className="top-0 w-full flex min-h-screen flex-col items-center justify-start mb-24">
            ...
            <FullWidthColorBackground variant="white" textColor="secondary">
                ...
                <div className="text-darkgreen-500 space-y-4 pt-8 text-2xl">
                    <p>
                        Your 1:1 Coaching Program to Restore Your Gut Health and
                    </p>
                    <p className="underline underline-offset-4 decoration-current font-transat-bold">
                        transform your health from the inside out…
                    </p>
                    <p>
                        Once you complete and submit your application, you will
                        be automatically redirected to a new page where you can
                        schedule your one-on-one Strategy Session with me.
                    </p>
                </div>
            ...
            {response?.type !== "success" ? (
                ...
                >
                    ...
                    <div className="flex flex-col gap-6">
                        <span className="p-1 text-bluegreen-500 text-lg font-transat-black">
                            What problems are you currently facing with your gut
                            or health?
                        </span>
                        <NFCTextArea
                    ...
                    <NFCTextArea
                        ...
                        onChange={(e) => {
                            setFormData({
                                ...formData,
                                more_about_problems: e.target.value,
                            })
                    ...
                    <NFCTextArea
                        ...
                        onChange={(e) => {
                            setFormData({
                                ...formData,
                                solutions_tried: e.target.value,
                            })
                    ...
                    <div className="flex flex-col gap-6">
                        <span className="p-1 text-bluegreen-500 text-lg font-transat-black">
                            Do you believe you can and will achieve your desired
                            health goals?
                        </span>
                        <NFCTextArea
                            label="Intro"
                    ...
                    <div className="flex flex-col gap-6">
                        <span className="p-1 text-bluegreen-500 text-lg font-transat-black">
                            This program is designed for action-oriented women
                            who are ready to learn, grow, be coached, and invest
                            in themselves.
                        </span>
                        <NFCTextArea
                            label="Intro"
                ...
                <FullWidthColorBackground variant="white" textColor="dark">
                    ...
                    <p className="text-center text-2xl">
                        You will be redirected to the scheduling page in{" "}
                        {countdown} seconds...
                    </p>
                </FullWidthColorBackground>
            )}
