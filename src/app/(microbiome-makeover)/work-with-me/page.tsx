		...
		<main className="top-0 w-full flex min-h-screen flex-col items-center justify-start">
			...
			<FullWidthColorBackground variant="white" textColor="secondary">
				<h1 className="font-transat-black text-balance pt-2 sm:pt-3 text-3xl sm:text-5xl text-center">
					<span className="text-lightgreen-500 uppercase">Microbiome </span>
					<span className="text-brightgreen-500 uppercase"> Makeover</span>
				</h1>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 text-xl px-2 sm:px-4 items-start content-center gap-20 max-w-7xl mx-auto">
					...
					>
						...
						<div className="flex flex-col font-transat-bold gap-4 text-2xl text-center text-balance">
							<p>
								You’re not willing to let your health issues, like pain,
								fatigue, or brain fog take over your life any longer.
							</p>
							<p>
								<span className="font-transat">
									You’re on a mission to feel as good as possible -
								</span>{" "}
					...
					>
						<div className="flex items-center overflow-hidden aspect-square">
							<div className="font-transat-bold bg-lightgreen-500 text-xl h-full w-full max-h-[400px] max-w-[400px] text-darkgreen-500 rounded-lg p-8 flex flex-col items-center justify-center gap-8">
								<p>
									You want your brain power going toward the things that matter
									most to you…like your family, your career, and your passions.
								</p>
								<p>
									…INSTEAD of spending your time preoccupied (held back) by the
						...
						<div className="flex flex-col font-transat-bold gap-4 text-2xl text-center text-balance">
							<p>
								You have enough to deal with as an ambitious woman.{" "}
								<span className="underline decoration-current underline-offset-4">
									There are so many moving parts in your life already.
								</span>
							</p>
							<p className="font-transat">
								What if I told you your body is working tirelessly to help you
								feel more energized, balanced, and comfortable? With the right
								approach, you can unlock a level of health beyond your wildest
								dreams.
							</p>
					...
					<FullWidthColorBackground variant="dark" textColor="white">
						<div>
							<p className="text-3xl font-transat-bold mb-8">
								ONCE YOU START MASTERING AND RESTORING YOUR GUT HEALTH…
							</p>
							You’ll emerge on the other side feeling like a new person with
							more focus, motivation, confidence, and energy (I could keep
							going!) to tackle your biggest goals – seriously,{" "}
							<span className="font-transat-bold">nothing</span> beats the
							freedom and vitality you can unlock.
						</div>
					</FullWidthColorBackground>
				</div>
				<div className="grid grid-cols-1 sm:grid-cols-2 px-2 sm:px-4 items-start content-center gap-20 text-center text-balance  max-w-7xl mx-auto">
					<div className="flex flex-col items-center gap-4 text-darkgreen-500 text-xl max-w-[400px] mx-auto">
						...
						<div className="grid grid-rows-[48px_48px_200px] gap-2">
							...
							<p>
								...
								<i>
									in addition to{" "}
									<b>running a top-rated health food restaurant</b>
								</i>{" "}
								– and studying the{" "}
								<span className="underline decoration-current underline-offset-4">
									latest in digestive health in my nutrition practice
								</span>
								…
							</p>
						</div>
						<div className="grid grid-rows-[48px_48px_200px] gap-2">
							...
							<p>
								I offer a proven roadmap to support your gut from top to bottom
								so you can show up in life as fully as possible.
							</p>
						</div>
						<div className="grid grid-rows-[48px_48px_200px] gap-2">
							<div className="mx-auto">
							...
							<p>
								I also utilize my training in cognitive coaching (which is a
								blend of neurology and psychology) to help you stay in action
								and develop health habits that you can (and want!) to stick with
								for the longhaul!
							</p>
						</div>
						<div className="grid grid-rows-[48px_48px_200px] gap-2">
							<div className="mx-auto">
								<NFCCircle variant="dark" design="filled" title="4" />
							</div>
							<h2 className="font-transat-med text-2xl text-center text-balance">
								INSIGHT
							</h2>
							<p>
								I’ve put together my experience, knowledge and insight to help
								you{" "}
								<span className="font-transat-bold">
									bypass your learning curve
								</span>{" "}
								without falling to prey to common traps so you can stay
								consistent and make a real difference. 🏆
							</p>
						</div>
					</div>
					<div className="flex flex-col items-center gap-4 text-brightgreen-500 text-xl max-w-[400px] mx-auto">
						...
						<div className="grid grid-rows-[48px_48px_200px] gap-2">
							...
							<p>
								A proven, step-by-step path to restore your gut health so you
								know exactly what to do to create lasting energy, comfort, and
								brain power — plus, lose weight with more ease.
							</p>
						</div>
						<div className="grid grid-rows-[48px_48px_200px] gap-2">
							<div className="mx-auto">
							...
							<p>
								Access to my growing resource & training library, including
								workshops and a private podcast to help you stay focused and
								confident as you create changes in your routines faster and with
								more ease. (Value: $2,000)
							</p>
						</div>
						<div className="grid grid-rows-[48px_48px_200px] gap-2">
							<div className="mx-auto">
								<NFCCircle variant="secondary" design="filled" title="4" />
							</div>
							<h2 className="font-transat-med text-2xl text-center text-balance">
								VOXER ACCESS
							</h2>
							<p>
								Voxer Access with me to ask questions & get on-demand support in
								the moments when you need it most. (Value: $3,000)
							</p>
						</div>
					</div>
				</div>
