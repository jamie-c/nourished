        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 text-xl px-2 sm:px-4 items-start content-center gap-20">
            ...
            >
                ...
                <p className="text-justify text-balance">
                    Are you{" "}
                    <span className="font-transat-med">
                        overwhelmed, stuck, or tired
                    </span>{" "}
                    of trying to find sustainable solutions to your health
                    challenges? Whether they be digestive issues, lack of
                    energy, brain fog, weight concerns, or autoimmunity. If
                    you&apos;re ready to be proactive in improving health
            ...
            >
                ...
                />
                <p className="text-justify text-balance">
                    Healthcare providers who are seeking functional-nutrition
                    education and support for their patients. We help fill the
                    gap between appointments, working with your patients to
                    improve their everyday habits to create better health
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 px-2 sm:px-4 items-start content-center gap-20 text-center text-balance">
            <div className="flex flex-col items-center gap-4 text-darkgreen-500 text-xl max-w-[400px] mx-auto">
                ...
                <div className="grid grid-rows-[48px_72px_200px] gap-2">
                    ...
                    <p>
                        Designed to help you better understand your body and
                        determine the foods and habits that will lead to the
                        results you’re seeking. They provide regular check-ins
                        to ensure you’re consistent and focused on the most
                        effect habits for your health.
                    </p>
                </div>
                <div className="grid grid-rows-[48px_72px_200px] gap-2">
                    <div className="mx-auto">
                    ...
                    <p>
                        For support, education, and inspiration between sessions
                        and beyond. Dig in to our on-demand cooking classes,
                        recipes, private community group, journal
                        prompts/exercises, and more.
                    </p>
                </div>
                <div className="grid grid-rows-[48px_72px_200px] gap-2">
                    <div className="mx-auto">
                    ...
                    <p>
                        The most important work happens outside of our sessions
                        — it’s taking action everyday. We provide continuous
                        support and focused direction with Voxer access and set
            ...
            <div className="flex flex-col items-center gap-4 text-brightgreen-500 text-xl max-w-[400px] mx-auto">
                ...
                <div className="grid grid-rows-[48px_72px_200px] gap-2">
                    ...
                    <p>
                        We start by getting to know who we’re helping — that’s
                        you! — through a comprehensive overview of your health
                        history and presenting challenges. This in-depth
                        assessment helps us uncover the best next steps toward
                ...
                <div className="grid grid-rows-[48px_72px_200px] gap-2">
                    ...
                    <p>
                        We make dietary & lifestyle recommendations that are
                        appropriate for you and what’s going on with your body.
                        We create highly individualized recommendations that
                        lead to results.
                    </p>
                </div>
                <div className="grid grid-rows-[48px_72px_200px] gap-2">
                    ...
                    <p>
                        We use tracking tools to make important connections
                        between your diet, habits, and symptoms to make sure
                        you’re engaging in the most effective changes for your
                        body.
                    </p>
                </div>
            </div>
