...
const FooterLinks = () => (
	...
	>
		<span className="w-full sm:w-screen-1/3 flex flex-col items-center justify-start gap-6">
			<Link href="/about">
				<button className="border-b-2 border-b-brightgreen-500 uppercase disabled:opacity-50 disabled:cursor-not-allowed">
					About
				</button>
			</Link>
			<Link href="/blog">
			...
			<Link href="/contact">
				<button className="border-b-2 border-b-brinbrgghtgreen-500 uppercase disabled:opacity-50 disabled:cursor-not-allowed">
					Contact
				</button>
			</Link>
		</span>
