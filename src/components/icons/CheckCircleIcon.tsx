export function CheckCircleIcon(props: React.ComponentPropsWithoutRef<"svg">) {
	return (
		<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#000000">
			<title>check-circle-solid</title>
			<g id="check-circle-icon" data-name="check-circle-icon">
				<path
					className="bg-bluegreen-500 fill-bluegreen-500"
