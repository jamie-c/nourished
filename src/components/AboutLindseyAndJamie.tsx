...
const AboutLindseyAndJamie: React.FC = () => (
	<div className="flex flex-col sm:flex-row items-start content-center gap-20">
		<div
			id="lindsey-conway"
			className="flex flex-col items-center sm:items-end max-w-xs text-center sm:text-right text-bluegreen-500"
		>
			<Image
				className="mb-4"
			...
			<p className="font-transat-light text-balance my-20 text-2xl h-48">
		...
		<div
			id="jamie-conway"
			className="flex flex-col items-center sm:items-start max-w-xs text-center sm:text-left text-darkgreen-500"
		>
			<Image
				className="mb-4"
