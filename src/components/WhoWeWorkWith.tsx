...
const WhoWeWorkWith = () => (
    <>
    <h2 className={`${transatBold.className} text-4xl text-center uppercase mt-32 mb-16 text-ndag-500 px-16 sm:px-4`}>WHO WE WORK WITH</h2>
    <div className="flex flex-col sm:flex-row items-start content-center gap-20 px-4">
        <div id="work-with-individuals" className="flex flex-col items-center max-w-xs text-center text-nbrg-500">
            ...
            <p className={`${transatLight.className} my-16 text-2xl text-justify`}>With our combined knowledge of the body&apos;s systems and food, we help people optimize how their bodies function, working with diet and lifestyle changes that lead to impactful, sustainable health change. Every recommendation is made with the individual in mind. This is not about fixed plans or one-size-fits-all approaches — it&apos;s a whole-person approach to health.</p>
        </div>
